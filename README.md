...
[Example RivaTuner configuration](https://i.troplo.com/i/7d15f779decc.gif). You must also enable Inject NVIDIA Reflex latency markers

## How to use
- Open it
- Import GTA keybinds from your control scheme or configure them yourself
- Configure macros
- Save your changes
- Play the game
